...
![main-screen.png](resources/illustrations/main-screen.png)
...
- **Не рекомендуется** использовать любой стиль, кроме **Fusion**, вместе с темной темой. Другие стили могут привести к неправильной отрисовке цветов. По умолчанию установлен стиль Fusion 11 — он работает корректно.
...
Проект распространяется под лицензией [Attribution-NonCommercial-ShareAlike 4.0 International](https://github.com/Technohamster-py/dm-assist/blob/main/LICENSE).
